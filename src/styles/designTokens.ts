...
export const TIER_COLORS = {
  0: {
    ...
    borderFocus: 'border-tier-0-text',
  ...
  1: {
    ...
    borderFocus: 'border-tier-1-text',
  ...
  2: {
    ...
    borderFocus: 'border-tier-2-text',
  ...
  3: {
    ...
    borderFocus: 'border-tier-3-text',
  ...
  4: {
    ...
    borderFocus: 'border-tier-4-text',
  ...
  5: {
    ...
    borderFocus: 'border-tier-5-text',
  ...
  6: {
    ...
    borderFocus: 'border-tier-6-text',
  ...
  7: {
    ...
    borderFocus: 'border-tier-7-text',
  ...
  8: {
    ...
    borderFocus: 'border-tier-8-text',
  ...
  9: {
    ...
    borderFocus: 'border-tier-9-text',
